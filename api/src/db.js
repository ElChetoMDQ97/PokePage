...
Pokemon.belongsToMany(Ability, { through: "PokemonAbilities" });
Ability.belongsToMany(Pokemon, { through: "PokemonAbilities" });
Pokemon.belongsToMany(Move, { through: "PokemonMoves" });
Move.belongsToMany(Pokemon, { through: "PokemonMoves" });
